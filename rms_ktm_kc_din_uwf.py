...
class FM(tf.keras.Model):
    ...
    def call(self, inp2, inp3, cur_kc, cur_kc_mask, cur_p, cur_u, training):
        ...
        study_user_embed = tf.concat([study_embed, cur_u], axis=2)

        study_embed = self.study_bn(self.study_dense(study_user_embed))
        ...
        cur_kc_p = tf.multiply(cur_kc, din)

        inp2 = tf.concat([inp2, cur_kc_p], 1)
