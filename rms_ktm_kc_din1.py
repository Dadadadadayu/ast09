...
class FM(tf.keras.Model):
    ...
    def call(self, inp2, inp3, cur_kc, cur_kc_mask, cur_p, training):
        ...
        self.wins_embed_2 = tf.reduce_sum(tf.multiply(self.wins_dense(self.wins_input), din), 1, keep_dims=True)
        self.fails_embed_2 = tf.reduce_sum(tf.multiply(self.fails_dense(self.fails_input), din), 1, keep_dims=True)
